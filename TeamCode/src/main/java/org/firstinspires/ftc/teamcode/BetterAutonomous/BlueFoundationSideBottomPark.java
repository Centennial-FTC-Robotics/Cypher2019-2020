...
@Autonomous(name = "blue parking on the foundation side towards the bottom with respect to the intial position only", group = "Auto")
public class BlueFoundationSideBottomPark {
    @Override
